...
if  ( ( isset($_POST['Alta'])) ) {
    ...
    $sql="INSERT INTO seg_usuarios(nombre, apellido, clave, usuario) VALUES ('$nombre', '$apellido', '$passwd', '$usuario')";
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-xl-8">
                    ...
                    <form action="alta.php" method="post" enctype="multipart/form-data" name="contact-form" >
                        ...
                        <div class="row gx-2">
                            <div class="form-floating col-md mb-3">
                                <input name="usuario" id="correoOrador" type="email" class="form-control" placeholder="Email" aria-label="Email" required>
                                <label for="correoOrador">Usuario</label>
                            </div>
                        </div>
                        <div class="row gx-2">
                            <div class="form-floating col-md mb-3">
                                <input name="clave" id="correoOrador" type="password" class="form-control" placeholder="Clave" aria-label="Email" required>
                                <label for="correoOrador">Clave</label>
                            </div>
                        </div>
